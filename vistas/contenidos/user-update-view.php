					...
					<div class="row">
						<div class="col-12 col-md-4">
							<div class="form-group">
								...
								<input type="text" value="<?php echo $campos['usuario_dni']; ?>" pattern="[0-9-]{1,20}" class="form-control" name="usuario_dni_up"
						...
						<div class="col-12 col-md-4">
							<div class="form-group">
								...
								<input type="text" value="<?php echo $campos['usuario_nombre']; ?>" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}"
									class="form-control" name="usuario_nombre_up" id="usuario_nombre"
									maxlength="35">
							</div>
						</div>
						<div class="col-12 col-md-4">
							<div class="form-group">
								...
								<input type="text" value="<?php echo $campos['usuario_apellido']; ?>" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="usuario_apellido_up" id="usuario_apellido" maxlength="35">
							</div>
						</div>
						<div class="col-12 col-md-6">
							<div class="form-group">
								<label for="usuario_telefono" class="bmd-label-floating">Teléfono</label>
								<input type="text" value="<?php echo $campos['usuario_telefono']; ?>" pattern="[0-9()+]{8,20}" class="form-control" name="usuario_telefono_up" id="usuario_telefono" maxlength="20">
							</div>
						</div>
						<div class="col-12 col-md-6">
							<div class="form-group">
								<label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
								<input type="text" value="<?php echo $campos['usuario_direccion']; ?>" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="usuario_direccion_up" id="usuario_direccion" maxlength="190">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-12 col-md-6">
							<div class="form-group">
								...
								<input type="text" value="<?php echo $campos['usuario_usuario']; ?>" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usuario_usuario_up" id="usuario_usuario" maxlength="35">
							</div>
						</div>
						<div class="col-12 col-md-6">
							<div class="form-group">
								<label for="usuario_email" class="bmd-label-floating">Email</label>
								<input type="email" value="<?php echo $campos['usuario_email']; ?>" class="form-control" name="usuario_email_up" id="usuario_email" maxlength="70">
							</div>
						</div>
