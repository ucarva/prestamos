                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="prestamo_estado_up" id="prestamo_estado">
                                    ...
                                    <option value="Finalizado" <?php if( $campos['prestamo_estado']=="Finalizado"){ echo '(Actual)';}?> >Finalizado <?php if( $campos['prestamo_estado']=="Finalizado"){ echo '(Actual)';}?> </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" value="<?php echo $campos['prestamo_observacion']?>" class="form-control" name="prestamo_observacion_up" id="prestamo_observacion" maxlength="400">
                            </div>
                        </div>
                    </div>
                </div>
