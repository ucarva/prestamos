...
?>
		...
		<?php }else{ ?>
			...
			<div class="container-fluid">
				<form class="FormularioAjax"  action="<?php echo SERVERURL;?>ajax/buscadorAjax.php"
			...
			<?php
				...
				echo $ins_usuario->paginador_usuario_controlador($pagina[1],3,$_SESSION['privilegio_spm'],
				$_SESSION['id_spm'],$pagina[0],$_SESSION['busqueda_usuario']);
